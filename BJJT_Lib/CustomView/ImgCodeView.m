...
-(void)requestCodeView:(int)codeIndex
{
    ...
    [[Globle getInstance].service requestWithServiceIP:[Globle getInstance].wxBaseServiceURL ServiceName:[@"appbase" stringByAppendingString:@"/appcodecreater"] params:nil httpMethod:@"POST"resultIsDictionary:YES completeBlock:^(id result)
     {
         if (result != nil)
         {
